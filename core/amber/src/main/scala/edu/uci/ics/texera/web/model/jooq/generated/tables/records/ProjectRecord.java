...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record4<UInteger, String, UInteger, Timestamp>, IProject {

    private static final long serialVersionUID = -395281059;
    ...
    @Override
    public ProjectRecord value3(UInteger value) {
        setOwnerId(value);
        return this;
    }
    ...
    @Override
    public ProjectRecord values(UInteger value1, String value2, UInteger value3, Timestamp value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProjectRecord(UInteger pid, String name, UInteger ownerId, Timestamp creationTime) {
        super(Project.PROJECT);

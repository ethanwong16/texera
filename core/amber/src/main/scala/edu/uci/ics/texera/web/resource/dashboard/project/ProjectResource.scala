...
class ProjectResource {
  ...
  def createProject(@PathParam("oid") oid: UInteger, @PathParam("name") name: String) = {
  ...
  def addWorkflowToProject(@PathParam("pid") pid: UInteger, @PathParam("wid") wid: UInteger) = {
  ...
  def addFileToProject(@PathParam("pid") pid: UInteger, @PathParam("fid") fid: UInteger) = {
